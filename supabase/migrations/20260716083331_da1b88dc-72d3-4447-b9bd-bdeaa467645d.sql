-- Update server-side pricing to be VAT-inclusive (20% VAT baked into every stored value).
-- Client and server MUST agree byte-for-byte or place_order will reject the totals.
...
RETURNS integer LANGUAGE sql IMMUTABLE SET search_path = public AS $$
  SELECT CASE _size_id
    ...
    WHEN '40x80'   THEN 600
    WHEN '50x70'   THEN 600
    WHEN '50x100'  THEN 720
    WHEN '60x90'   THEN 720
    WHEN '60x120'  THEN 900
    WHEN '70x100'  THEN 900
    WHEN '80x120'  THEN 1020
    WHEN '70x140'  THEN 1140
    WHEN '100x150' THEN 1560
    WHEN '80x160'  THEN 1800
    WHEN '100x200' THEN 2400
    -- Square
    WHEN '30x30'   THEN 420
    WHEN '40x40'   THEN 420
    WHEN '50x50'   THEN 480
...
BEGIN
  ...
  IF mn <= 70 AND mx <= 100 THEN RETURN 300; END IF;
  RETURN 420;
END $$;

-- Update shipping branch inside place_order (VAT-inclusive threshold and fee).
